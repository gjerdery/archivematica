...
if __name__ == '__main__':
    ...
    fileUUID = sys.argv[4]
    sipDirectory = sys.argv[5]

    outputDirectory = os.path.join(sipDirectory, "logs", "bulk-" + fileUUID)
    os.makedirs(outputDirectory)
    command = "bulk_extractor \"" + escapeForCommand(target) + "\" -o \"" + outputDirectory + "\" -M 250 -q -1" 
